...
CREATE TABLE `cm_info` (
  ...
  `AV` varbinary(200) DEFAULT NULL COMMENT '合同编号',
  ...
  `CI` varbinary(200) DEFAULT NULL COMMENT '产品类型',
  ...
  `CW` int(11) DEFAULT NULL COMMENT '第一个小孩年龄阶段',
  `CX` int(11) DEFAULT NULL COMMENT '第二个小孩年龄阶段',
...
CREATE TABLE `sys_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='系统-角色';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (2,'管理员','管理系统','org_yxb,org_dq,org_jxs,city_sf,city_cs,sqr_xm,sqr_zjlx,sqr_zjhm,sqr_dhhm,sjgcr_xm,sjgcr_zjhm,sjgcr_dhhm,gsqrgx,hkzt,xb,nl,hyzk,dqzt,htbh,htjhrq,sqtjrq,yf,hzjjrq,zc,cxi,cxing,cphm,vin,gcrq,jcrq,fkfs,jszbh,jzdqr,jtrs,jycd,dksqhm,hylx,hyzlx,zylx,hkszd,ysr,jkr_sf,jkr_cs,hkdz,dzlx,fclx,jznx,gsmc,qyxz,zw,gsdh,dzy,gznx,zcjg,csys,cpz,cplx,dkqs,xsjg,sfkbl,sfkje,dkje,khll,lxze,gcyhke,khsqbm,jsr_xm,jsr_lxdh,xqah,yyxhsl,dygxhnljd,degxhnljd,bz,yqr'),(4,'三级用户','三级用户权限','org_yxb,org_dq,org_jxs,city_sf,city_cs,sqr_xm,sqr_zjlx,sqr_zjhm,sqr_dhhm,sjgcr_xm,sjgcr_zjhm,sjgcr_dhhm,gsqrgx,hkzt,xb,nl,hyzk,dqzt,htbh,htjhrq,sqtjrq,yf,hzjjrq,zc,cxi,cxing,cphm,vin,gcrq,jcrq,fkfs,jszbh,jzdqr,jtrs,jycd,dksqhm,hylx,hyzlx,zylx,hkszd,ysr,jkr_sf,jkr_cs,hkdz,dzlx,fclx,jznx,gsmc,qyxz,zw,gsdh,dzy,gznx,zcjg,csys,cpz,cplx,dkqs,xsjg,sfkbl,sfkje,dkje,khll,lxze,gcyhke,khsqbm,jsr_xm,jsr_lxdh,xqah,yyxhsl,dygxhnljd,degxhnljd,bz,yqr'),(5,'一级用户','一级用户权限','org_jxs,city_sf,city_cs,sqr_xm,sqr_zjlx,sqr_zjhm,sqr_dhhm,sjgcr_xm,sjgcr_zjhm,sjgcr_dhhm,xb,nl,hyzk,sqtjrq,cxi,cxing,cphm,vin,gcrq,jcrq,fkfs,jtrs,jycd,hylx,hyzlx,zylx,hkszd,zw,gsdh,dzy,zcjg,csys,cpz,cplx,khsqbm,xqah,yyxhsl,dygxhnljd,degxhnljd'),(6,'二级用户','二级用户权限','org_yxb,org_dq,org_jxs,city_sf,city_cs,sqr_xm,sqr_zjlx,sqr_zjhm,sqr_dhhm,sjgcr_xm,sjgcr_zjhm,sjgcr_dhhm,gsqrgx,nl,hyzk,sqtjrq,cxi,cxing,cphm,vin,gcrq,jcrq,fkfs,jtrs,jycd,hylx,hyzlx,zylx,hkszd,jkr_sf,jkr_cs,hkdz,dzlx,gsmc,qyxz,zw,gsdh,dzy,gznx,zcjg,csys,cpz,cplx,dkqs,xsjg,khsqbm,jsr_xm,jsr_lxdh,xqah,yyxhsl,dygxhnljd,degxhnljd,bz,yqr');
...
) ENGINE=InnoDB AUTO_INCREMENT=720 DEFAULT CHARSET=utf8 COMMENT='系统-角色-菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_menu` VALUES (632,4,1),(633,4,6),(634,4,41),(635,4,42),(639,2,1),(640,2,9),(641,2,6),(642,2,10),(643,2,43),(644,2,8),(645,2,14),(646,2,41),(647,2,42),(648,2,2),(649,2,3),(650,2,39),(651,2,31),(652,2,32),(653,2,33),(654,2,4),(655,2,37),(656,2,25),(657,2,26),(658,2,27),(659,2,5),(660,2,35),(661,2,19),(662,2,20),(663,2,21),(664,2,7),(665,2,36),(666,2,22),(667,2,23),(668,2,24),(669,2,11),(670,2,34),(671,2,15),(672,2,16),(673,2,17),(674,2,12),(675,2,38),(676,2,28),(677,2,29),(678,2,30),(679,2,13),(680,2,40),(681,2,18),(702,5,1),(703,5,6),(704,5,41),(705,5,42),(716,6,1),(717,6,6),(718,6,41),(719,6,42);
...
-- Dump completed on 2016-12-11 20:12:48
